...
namespace Uforresporting\Component\Uforeporting\Administrator\View\Domains;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_UFOREPORTING_TITLE_DOMAINS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_uforeporting&view=domains');
	}
	...
	{
		return array(
			'a.`code`' => Text::_('COM_UFOREPORTING_DOMAINS_CODE'),
			'a.`name`' => Text::_('COM_UFOREPORTING_DOMAINS_NAME'),
			'a.`description`' => Text::_('COM_UFOREPORTING_DOMAINS_DESCRIPTION'),
			'a.`minus_range`' => Text::_('COM_UFOREPORTING_DOMAINS_MINUS_RANGE'),
			'a.`equal_range`' => Text::_('COM_UFOREPORTING_DOMAINS_EQUAL_RANGE'),
			'a.`plus_range`' => Text::_('COM_UFOREPORTING_DOMAINS_PLUS_RANGE'),
			'a.`state`' => Text::_('JSTATUS'),
			'a.`ordering`' => Text::_('JGRID_HEADING_ORDERING'),
			'a.`id`' => Text::_('JGRID_HEADING_ID'),
			'a.`created_by`' => Text::_('COM_UFOREPORTING_DOMAINS_CREATED_BY'),
		);
	}
