...
namespace Uforresporting\Component\Uforeporting\Administrator\View\Domain;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_UFOREPORTING_TITLE_DOMAIN'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_uforeporting.domain', $this->item->id);
		}
