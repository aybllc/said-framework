...
{
	/**
	 * Method to clone existing Vehicles
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_uforeporting&view=vehicles');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Vehicle', $prefix = 'Administrator', $config = array())
	{
