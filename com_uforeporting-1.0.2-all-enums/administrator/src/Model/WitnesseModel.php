 ...
 * @since  1.0.0
 */
class WitnesseModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_uforeporting.witnesse';
	...
	/**
	 * Method to duplicate an Witnesse
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ommp_witnesses');
				$max             = $db->loadResult();
