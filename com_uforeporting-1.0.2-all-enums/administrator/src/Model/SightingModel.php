 ...
 * @since  1.0.0
 */
class SightingModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_uforeporting.sighting';
	...
	/**
	 * Method to duplicate an Sighting
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ommp_sightings');
				$max             = $db->loadResult();
