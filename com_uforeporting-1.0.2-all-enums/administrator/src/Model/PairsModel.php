...
/**
 * Methods supporting a list of Pairs records.
 *
 * @since  1.0.0
 */
class PairsModel extends ListModel
{
	/**
	* Constructor.
	*
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				'observer_domain', 'a.observer_domain',
				'object_domain', 'a.object_domain',
				'reason', 'a.reason',
				'id', 'a.id',
				'ordering', 'a.ordering',
				'state', 'a.state',
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__ommp_invalid_pairs` AS a');
