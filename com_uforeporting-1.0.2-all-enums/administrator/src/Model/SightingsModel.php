...
/**
 * Methods supporting a list of Sightings records.
 *
 * @since  1.0.0
 */
class SightingsModel extends ListModel
{
	/**
	* Constructor.
	*
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'--', 'a.--',
				'obj_mod', 'a.obj_mod',
				'obj_substrate', 'a.obj_substrate',
				'behavior_code', 'a.behavior_code',
				'speed_mod', 'a.speed_mod',
				'shape_code', 'a.shape_code',
				'size_mod', 'a.size_mod',
				'--', 'a.--',
	...
	protected function getStoreId($id = '')
	{
		...
		if(!$id || $this->userIDItem($id) || $this->isAdminOrSuperUser() || $this->isUserCreatedItem() || Factory::getUser()->authorise('core.manage', 'com_uforeporting')){
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__ommp_sightings` AS a');
