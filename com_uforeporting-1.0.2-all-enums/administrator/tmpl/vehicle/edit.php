...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="vehicle-form" class="form-validate form-horizontal">

	
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'vehicle')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'vehicle', Text::_('COM_UFOREPORTING_TAB_VEHICLE', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_UFOREPORTING_FIELDSET_VEHICLE'); ?></legend>
				<?php echo $this->form->renderField('code'); ?>
				<?php echo $this->form->renderField('name'); ?>
				<?php echo $this->form->renderField('definition'); ?>
			</fieldset>
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_UFOREPORTING_FIELDSET_BASIC'); ?></legend>
