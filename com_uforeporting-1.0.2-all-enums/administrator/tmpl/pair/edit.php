...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="pair-form" class="form-validate form-horizontal">

	
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'pair')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'pair', Text::_('COM_UFOREPORTING_TAB_PAIR', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_UFOREPORTING_FIELDSET_PAIR'); ?></legend>
				<?php echo $this->form->renderField('observer_domain'); ?>
				<?php echo $this->form->renderField('object_domain'); ?>
