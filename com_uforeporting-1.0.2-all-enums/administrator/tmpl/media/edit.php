...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="media-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_UFOREPORTING_FIELDSET_MEDIA'); ?></legend>
