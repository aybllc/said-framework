...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="behavior-form" class="form-validate form-horizontal">

	
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'behavior')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'behavior', Text::_('COM_UFOREPORTING_TAB_BEHAVIOR', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_UFOREPORTING_FIELDSET_BEHAVIOR'); ?></legend>
				<?php echo $this->form->renderField('behavior_code'); ?>
				<?php echo $this->form->renderField('behavior_name'); ?>
				<?php echo $this->form->renderField('behavior_description'); ?>
