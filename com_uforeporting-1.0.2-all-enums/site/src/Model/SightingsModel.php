...
/**
 * Methods supporting a list of Uforeporting records.
 *
 * @since  1.0.0
 */
class SightingsModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_uforeporting'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_UFOREPORTING_SEARCH_FILTER_DATE_FORMAT"), "warning");
