...
if($this->item->id) {
	$canState = Factory::getApplication()->getIdentity()->authorise('core.edit.state','com_uforeporting.witnesse');
} else {
	$canState = Factory::getApplication()->getIdentity()->authorise('core.edit.state','com_uforeporting.witnesse.'.$this->item->id);
}
?>

<div class="witnesse-edit front-end-edit">
...
<?php if ($this->params->get('show_page_heading')) : ?>
	...
	<?php else : ?>
		...
		<form id="form-witnesse"
			  action="<?php echo Route::_('index.php?option=com_uforeporting&task=witnesseform.save'); ?>"
			  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
			
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'witnesse')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'witnesse', Text::_('COM_UFOREPORTING_TAB_WITNESSE', true)); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_uforeporting&task=witnesseform.cancel'); ?>"
