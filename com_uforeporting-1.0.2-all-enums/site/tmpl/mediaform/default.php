...
if($this->item->id) {
	$canState = Factory::getApplication()->getIdentity()->authorise('core.edit.state','com_uforeporting.media');
} else {
	$canState = Factory::getApplication()->getIdentity()->authorise('core.edit.state','com_uforeporting.media.'.$this->item->id);
}
?>
...
<?php if ($this->params->get('show_page_heading')) : ?>
	...
	<?php else : ?>
		...
		<form id="form-media"
			  action="<?php echo Route::_('index.php?option=com_uforeporting&task=mediaform.save'); ?>"
			  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
			
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'media')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'media', Text::_('COM_UFOREPORTING_TAB_MEDIA', true)); ?>
	<?php echo $this->form->renderField('id'); ?>

	<?php echo $this->form->renderField('sighting_id'); ?>

	<?php echo $this->form->renderField('kind'); ?>

	<?php echo $this->form->renderField('uri'); ?>

	<?php echo $this->form->renderField('mime'); ?>

	<?php echo $this->form->renderField('captured_at'); ?>

	<?php echo $this->form->renderField('meta'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_uforeporting&task=mediaform.cancel'); ?>"
